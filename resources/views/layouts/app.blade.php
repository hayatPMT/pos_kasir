  ...
  <aside class="w-72 bg-slate-950 text-white flex-shrink-0 fixed h-full z-50 transition-all duration-500 ease-in-out border-r border-white/5">
   <div class="h-full flex flex-col p-8">
    ...
    <nav class="flex-1 space-y-1.5 scrollbar-hide overflow-y-auto pr-2">
     <!-- SECTION: TERMINAL & SALES (All Roles) -->
     <div class="pt-4 pb-3 px-4">
      <p class="text-white/20 text-[10px] font-black uppercase tracking-[0.3em]">Main Terminal</p>
     </div>
     <x-nav-link href="{{ route('dashboard') }}" :active="request()->routeIs('dashboard')" icon="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6">Dashboard</x-nav-link>
     <x-nav-link href="{{ route('pos.index') }}" :active="request()->routeIs('pos.*')" icon="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z">Point of Sale</x-nav-link>
     <x-nav-link href="{{ route('shifts.index') }}" :active="request()->routeIs('shifts.*')" icon="M12 8v4l3 2m6-2a9 9 0 11-18 0 9 9 0 0118 0z">Work Shift</x-nav-link>

     <!-- SECTION: INVENTORY & CRM (Admin & Superadmin) -->
     @if(in_array(Auth::user()->role, ['super_admin', 'branch_admin']))
     <div class="pt-8 pb-3 px-4">
      <p class="text-white/20 text-[10px] font-black uppercase tracking-[0.3em]">Inventory & CRM</p>
     </div>
     <x-nav-link href="{{ route('products.index') }}" :active="request()->routeIs('products.*')" icon="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4">Global Products</x-nav-link>
     <x-nav-link href="{{ route('suppliers.index') }}" :active="request()->routeIs('suppliers.*')" icon="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2-5h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4">Suppliers</x-nav-link>
     <x-nav-link href="{{ route('purchase-orders.index') }}" :active="request()->routeIs('purchase-orders.*')" icon="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01">Procurement</x-nav-link>
     <x-nav-link href="{{ route('stock-opnames.index') }}" :active="request()->routeIs('stock-opnames.*')" icon="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2">Inventory Audit</x-nav-link>
     <x-nav-link href="{{ route('members.index') }}" :active="request()->routeIs('members.*')" icon="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z">Customer Loyalty</x-nav-link>
     <x-nav-link href="{{ route('promotions.index') }}" :active="request()->routeIs('promotions.*')" icon="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z">Campaigns</x-nav-link>
     @endif

     <!-- SECTION: ANALYTICS & PLANNING (Superadmin & Admin for Schedules) -->
     @if(in_array(Auth::user()->role, ['super_admin', 'branch_admin']))
     <div class="pt-8 pb-3 px-4">
      <p class="text-white/20 text-[10px] font-black uppercase tracking-[0.3em]">Business Intel</p>
     </div>
     <x-nav-link href="{{ route('schedules.index') }}" :active="request()->routeIs('schedules.*')" icon="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z">Staff Schedules</x-nav-link>
     @if(Auth::user()->role === 'super_admin')
     <x-nav-link href="{{ route('analytics.index') }}" :active="request()->routeIs('analytics.*')" icon="M9 17v-2m3 2v-4m3 4v-6m2 10H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z">Sales Analytics</x-nav-link>
     <x-nav-link href="{{ route('reports.index') }}" :active="request()->routeIs('reports.*')" icon="M9 17v-2m3 2v-4m3 4v-6m2 10H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z">Financial Reports</x-nav-link>
     @endif
     @endif

     <!-- SECTION: ADMINISTRATION (Superadmin Only mostly) -->
     @if(in_array(Auth::user()->role, ['super_admin', 'branch_admin']))
     <div class="pt-8 pb-3 px-4">
      <p class="text-white/20 text-[10px] font-black uppercase tracking-[0.3em]">Infrastructure</p>
     </div>
