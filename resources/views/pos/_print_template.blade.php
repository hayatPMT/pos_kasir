 ...
 <div class="relative min-h-screen flex items-center justify-center p-4">
  <div class="bg-white w-full max-w-sm rounded-[2.5rem] shadow-2xl overflow-hidden animate-in zoom-in duration-300">
   ...
   <div class="p-6 bg-slate-50 border-t border-slate-100 flex gap-3">
    <button onclick="closeReceiptModal()" class="flex-1 py-4 rounded-xl font-black text-[9px] uppercase tracking-widest text-slate-400 hover:text-slate-600 transition-colors">Close</button>
    <button onclick="shareWhatsApp()" class="flex-1 bg-emerald-100 text-emerald-600 py-4 rounded-xl font-black text-[9px] uppercase tracking-widest hover:bg-emerald-600 hover:text-white transition-all flex items-center justify-center gap-2">
    ...
    <button onclick="printReceipt()" class="flex-[2] bg-indigo-600 text-white py-4 rounded-xl font-black text-[9px] uppercase tracking-widest shadow-xl shadow-indigo-600/20 hover:bg-indigo-700 transition-all">Print Receipt</button>
   </div>
  </div>
 </div>
</div>
